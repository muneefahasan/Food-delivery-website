    ...
    return (
        <div className='bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 min-h-screen py-16 px-4 sm:px-6 lg:px-8'>
            <div className='max-w-7xl mx-auto'>
                <h2 className='text-4xl sm:text-5xl md:text-6xl font-bold text-center mb-12 bg-clip-text text-transparent bg-gradient-to-r from-purple-200 via-purple-300 to-purple-200'>
                ...
                <div className='flex flex-wrap justify-center gap-4 mb-16'>
                    {categories.map(cat => (
                        ...
                        font-cinzel text-sm sm:text-lg tracking-widest backdrop-blur-sm ${activeCategory === cat ?
                                    'bg-gradient-to-r from-purple-900/80 to-indigo-700/80 border-purple-800 scale-100 text-white' : 'bg-gray-800/20 border-purple-800/30 text-purple-100/80 hover:bg-purple-800/30'}`}>
                            {cat}
                        </button>
                    ))}
                </div>
                ...
                <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-4'>
                    {displayItems.length > 0 ? (
                        displayItems.map((item, i) => {
                            ...
                            return (
                                <div key={item.id} className='relative bg-gray-900/20 rounded-2xl overflow-hidden border border-purple-800/30 backdrop-blur-sm flex flex-col transition-all duration-500 hover:border-purple-600/50'
                                    style={{ '--index': i }}>
                                    ...
                                    <div className='p-4 sm:p-6 flex flex-col flex-grow'>
                                        ...
                                        <div className='mt-auto flex items-center gap-4 justify-between'>
                                            <div className='bg-purple-100/10 backdrop-blur-sm px-3 py-1 rounded-2xl shadow-lg border border-purple-500/20'>
                        ...
                        <div className="col-span-full text-center text-purple-100/50 text-xl font-cinzel py-12">
                ...
                <div className='flex justify-center mt-16'>
                    <Link className='bg-purple-900/30 border-2 border-purple-800/30 text-purple-100 px-8
            sm:px-10 py-3 rounded-full font-cinzel uppercase tracking-widest transition-all duration-300
            hover:bg-purple-800/40 hover:text-purple-50 hover:scale-105 hover:shadow-lg
            hover:shadow-purple-900/20 backdrop-blur-sm' to='/menu'>
                        Explore full Menu
                    </Link>
                </div>
