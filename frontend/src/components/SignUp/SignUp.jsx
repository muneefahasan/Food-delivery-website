...
const handleSubmit = e => {
        ...
        <div className='min-h-screen flex items-center justify-center bg-[#1a120b] p-4'>
            {showToast && <AwesomToast message="sign up succefull" icons{<FaCHECKcircle />}}
            ...
            bg-clip-text text-transparent mb-6 hover:scale-105 transition-transform'>
                ...
                <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    <div className='relative'>
                        ...
                        <button className='absolute inset-y-0 right-4 flex items-center pr-3 text-amber-400 hover:text-amber-600 transform hover:scale-125' type='button' onClick={toggleShowPassword}>
                    ...
                    <button type='submit' className='w-full py-3 bg-gradient-to-r from-amber-400 to-amber-600 text-[#2D1B0E] font-bold rounded-lg hover:scale-105 transition-transition-all duration-300 transform hover:shadow-lg'>
                        Sign Up
                ...
                <div className='mt-6 text-center'>
                    ...
                    <link to='/login className=' group inline-flex items-center text-amber-400 hoverL text-amber-600 transition-all duration-300'>

                    <FaArrowLeft className='mr-2 transform -translate-x-2 opacity-0group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-300' />
